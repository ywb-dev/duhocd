...
const model = ref([
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Blog posts', icon: 'pi pi-fw pi-check-square', to: '/admin/blogs' },
        ]
    },  
     {
        label: 'Pages',
        ...
        items: [
            ...
            {
                label: 'Duhocd landing',
                icon: 'pi pi-fw pi-globe',
                to: 'https://www.landing.duhocd.com/',
                target_blank: true
            }
        ]
     }
